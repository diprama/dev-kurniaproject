...
<head>
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
	<title>Kurnia Project - Interior</title>
						...
						<div class="row">
							<div class="col-md-9">
								<div class="column_attr clearfix mobile_align_center">
									<h1>Interior <b>Studio</b></h1>
									<hr class="no_line" style="margin: 0 auto 20px auto" />
									<p> Ruang yang indah dan fungsional bukanlah sekadar impian. Di sini, kami mewujudkan visi Anda menjadi realita. Dengan perhatian pada detail dan dedikasi untuk kualitas, kami mengubah setiap ruang menjadi tempat yang nyaman, berestetika, dan berkarakter. Mari bersama menciptakan suasana yang merefleksikan gaya hidup dan kepribadian Anda. </p>
								</div>
							</div>
						</div>
					</div>
