				...
				<div class="container">
					<div class="row">
						<div class="col-12" data-col="one">
							<hr class="no_line" style="margin: 0 auto  auto" /> </div>
						<div class="col-md-4" data-col="one-third">
							<div class="row">
								<div class="col-md-3 column_column">
									<div class="column_attr clearfix mobile_align_center animate" data-anim-type="bounceIn" style="padding:0 5% 0 2%;">
										<h3 class="themecolor"><b>01</b></h3> </div>
								</div>
								<div class="col-md-9">
									<div class="column_attr clearfix mobile_align_center" style="padding:0 5% 0 2%;">
										<h5>Kami memulai dengan memahami kebutuhan dan visi klien, lalu merancang solusi konstruksi yang efisien dan inovatif. Tim ahli kami akan menyusun blueprint yang terperinci untuk memastikan hasil akhir sesuai ekspektasi.</h5> </div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4" data-col="one-third">
							<div class="row">
								<div class="col-md-3 column_column">
									<div class="column_attr clearfix mobile_align_center animate" data-anim-type="bounceIn" style="padding:0 5% 0 2%;">
										<h3 class="themecolor"><b>02</b></h3> </div>
								</div>
								<div class="col-md-9">
									<div class="column_attr clearfix mobile_align_center" style="padding:0 5% 0 2%;">
										<h5>Kami memulai dengan memahami kebutuhan dan visi klien, lalu merancang solusi konstruksi yang efisien dan inovatif. Tim ahli kami akan menyusun blueprint yang terperinci untuk memastikan hasil akhir sesuai ekspektasi.</h5> </div>
						...
						<div class="col-md-4" data-col="one-third">
							<div class="row">
								<div class="col-md-3 column_column">
									<div class="column_attr clearfix mobile_align_center animate" data-anim-type="bounceIn" style="padding:0 5% 0 2%;">
										<h3 class="themecolor"><b>03</b></h3> </div>
								</div>
								<div class="col-md-9">
									<div class="column_attr clearfix mobile_align_center" style="padding:0 5% 0 2%;">
										<h5>Kami memulai dengan memahami kebutuhan dan visi klien, lalu merancang solusi konstruksi yang efisien dan inovatif. Tim ahli kami akan menyusun blueprint yang terperinci untuk memastikan hasil akhir sesuai ekspektasi.</h5> </div>
